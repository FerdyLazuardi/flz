  ...
  return (
    <>
      ...
      >
        ...
        <div>
        <div className="bg-white/90 dark:bg-neutral-900/85 backdrop-blur-3xl border border-black/10 dark:border-white/15 rounded-2xl shadow-[0_12px_48px_rgba(0,0,0,0.18)] overflow-hidden flex flex-col">
          {/* Header */}
      ...
      <div
        className={[
          ...
          "bg-white/90 dark:bg-neutral-900/85 backdrop-blur-3xl border border-black/10 dark:border-white/15 rounded-full",
