...
import { ArrowRight, X, Play, Plus, ThumbsUp } from "lucide-react"
...
function getProjectImage(project: ProjectData) {
...
function LusionCard({ project, onClick }: { project: ProjectData, onClick: () => void }) {
  ...
  return (
    ...
    >
      {/* Image Reveal Wrapper - Triggers separate from text */}
      <motion.div 
        variants={{
      ...
      {/* Text Reveal Wrapper - Delays behind image */}
      <motion.div 
        variants={{
      ...
      >
        ...
        >
          ...
          <div className="relative flex items-center w-full">
            {/* Arrow absolutely positioned so heading stays perfectly left-aligned */}
...
function ExpandedView({ project, onClose }: { project: ProjectData, onClose: () => void }) {
  const imageSrc = getProjectImage(project);
  let vidId = null;
      ...
      >
         ...
         <div className="flex flex-col w-full h-full overflow-y-auto overflow-x-hidden relative">
           ...
           >
              ...
              {/* Gradient fade at bottom to blend into the content area, plus global dark tint for readability */}
           ...
           {/* Content Detail Area stacked at bottom */}
           <div className="relative z-20 flex-1 flex flex-col justify-end w-full mt-auto p-6 pb-10 pl-8 md:p-12 md:pb-16 md:pl-16 lg:pb-20 lg:pl-20 min-h-fit pt-48">
             ...
             >
                <Link href={`/projects/${project.slug}`}>
                   <button className="group flex items-center gap-2.5 px-6 md:px-8 py-2.5 md:py-3 bg-white hover:bg-[#e6e6e6] active:scale-95 transition-all duration-300 ease-out text-black font-bold rounded shadow-lg hover:shadow-xl md:text-xl">
                     <ArrowRight className="w-5 h-5 md:w-6 md:h-6 text-black transition-transform duration-300 ease-out group-hover:translate-x-1.5" />
                     View Project
                   </button>
                </Link>
             </motion.div>

             {/* Text Metadata y Description */}
             <motion.div 
             ...
             >
               ...
               <div className="flex flex-wrap justify-start items-center gap-2 md:gap-4 font-sans font-bold text-sm md:text-base">
                 ...
                 <span className="relative flex items-center shrink-0 drop-shadow-md">
                   <Image 
                     src="/logo project/amratha.png" 
                     alt="Amartha Logo" 
                     width={160} 
                     height={40} 
...
export function FeaturedProjects({ projects }: { projects: ProjectData[] }) {
  ...
  return (
    <section className={`py-16 md:py-24 relative overflow-x-hidden ${activeProject ? 'z-[100]' : 'z-10'}`}>
      <div className="relative z-10 px-6 sm:px-10 lg:px-14 mx-auto w-full max-w-[1800px]">
        ...
        <div className="flex flex-col items-center text-center mb-16 lg:mb-24">
          ...
          >
            <h2 className="font-heading text-4xl md:text-5xl lg:text-7xl font-black text-text-primary mb-6 tracking-tighter">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl text-lg md:text-xl leading-relaxed">
        ...
        {/* 2-Column Grid Layout - Reduced gap to be tighter */}
