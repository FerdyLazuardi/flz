...
export function FeaturedProjects({ projects }: { projects: ProjectData[] }) {
  ...
  return (
    <section id="projects" className={`py-12 sm:py-16 md:pt-16 md:pb-32 lg:py-32 relative overflow-visible ${selectedId ? 'z-[9999]' : 'z-10'}`}>
      ...
      <div className="relative z-10 px-5 sm:px-10 lg:px-14 mx-auto w-full max-w-[1800px]">
        ...
        <div className="flex flex-col items-center text-center mb-12 sm:mb-16 lg:mb-24">
          ...
          >
            <h2 className="font-heading text-[1.95rem] sm:text-4xl md:text-5xl lg:text-6xl font-black text-text-primary mb-5 sm:mb-6 tracking-normal leading-tight md:leading-[1.05]">
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl text-[13px] sm:text-base md:text-lg leading-relaxed">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-x-6 lg:gap-x-12 gap-y-10 sm:gap-y-12 lg:gap-y-20">
