  ...
  return (
    <section id="value" ref={ref} className="py-12 sm:py-16 md:py-32 relative overflow-visible">
      ...
      <div className="container mx-auto px-5 sm:px-8 lg:px-12 max-w-7xl">
        ...
        >
          <h2 className="font-heading text-[1.95rem] sm:text-4xl md:text-5xl lg:text-6xl font-black text-text-primary mb-5 sm:mb-6 tracking-normal leading-[1.1] sm:leading-[1.05]">
            End-to-End <br />
